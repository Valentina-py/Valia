...
(function () {
  ...
  function renderHome() {
    ...
    mount(`
      <h1 class="page-title">Plataforma de estudio de Estadística</h1>
      <p class="page-sub">Estadística Descriptiva · Teoría, ejemplos resueltos, práctica guiada y autoevaluación.</p>
