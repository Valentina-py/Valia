...
(function () {
  ...
  const GAMES = [
    { id: "etiquetas", icon: "letters", title: "¿Qué etiqueta?", desc: "Elegí la etiqueta HTML correcta para cada situación." },
    { id: "css", icon: "link", title: "¿Qué propiedad CSS?", desc: "Adiviná la propiedad de CSS que logra cada efecto." },
    { id: "vof", icon: "timer", title: "Verdadero o Falso", desc: "Decidí si cada afirmación sobre desarrollo web es verdadera o falsa." },
  ];
